...
export default function AcademyEditModal({ academy, onClose, onSaved }: AcademyEditModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative w-full sm:max-w-5xl bg-white rounded-t-2xl sm:rounded-2xl shadow-xl max-h-[92vh] flex flex-col min-w-0">
        ...
        <div className="overflow-y-auto overflow-x-hidden px-3 sm:px-5 pb-4 min-w-0">
          <AcademyForm
            mode="edit"
            compact
